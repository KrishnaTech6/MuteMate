...
import com.krishna.mutemate.utils.cancelUnmuteAlarm
...
@AndroidEntryPoint
class CancelMuteReceiver: BroadcastReceiver() {
    @Inject
    lateinit var dao: MuteScheduleDao
    override fun onReceive(context: Context, intent: Intent) {
        val scheduleId = intent.getLongExtra(SCHEDULE_ID, -1)
        cancelUnmuteAlarm(scheduleId, context)
